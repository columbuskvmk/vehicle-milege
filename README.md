vehicle mileage app [SpringBoot](http://projects.spring.io/spring-boot/) RESTful web service application with [Docker](https://www.docker.com/) and with [Kubernetes](https://kubernetes.io/)
...
```
git clone https://github.com/columbuskvmk/vehicle-milege.git
```

##### Build Docker image
```
docker build -t="vehicle-milege-java" .
```
Maven build will executes during creation of the docker image.

>Note:if you run this command for first time it will take some time in order to download base image from [DockerHub](https://hub.docker.com/)

##### Run Docker Container
```
docker run -p 8081:8081 -it --rm vehicle-milege-java
```
...
```
docker stop `docker container ls | grep "vehicle-milege-java:*" | awk '{ print $1 }'`
```
...
```
kubectl create deployment hello-spring-boot --image=dstar55/docker-vehicle-milege-spring-boot:latest
```
